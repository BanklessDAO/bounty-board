...
export const WARNINGS = {
	ADBLOCKER: 'Page not working as expected? Adblockers such as Privacy Badger have been known to cause interference with the bounty board, please try disabling.',
};