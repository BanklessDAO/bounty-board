...
): Promise<AxiosResponse<{ data: BountyCollection }>> => {
	const deleteData: Partial<BountyCollection> = {
		activityHistory: newActivityHistory(
           bounty.activityHistory as [],
           ACTIVITY.DELETE
		),
		statusHistory: newStatusHistory(
           bounty.statusHistory as [],
           BOUNTY_STATUS.DELETED
		),
		...
		<Modal onClose={onClose} isOpen={isOpen} isCentered>
			...
			<ModalContent>
				...
				<ModalBody flexDirection="column" justifyContent="space-evenly">
					<Text>
                      Please confirm you want to delete this bounty.
